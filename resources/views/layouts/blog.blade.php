...
<body>
    ...
    <!-- Navbar -->
    <nav class="navbar  navbar-expand-lg navbar-dark navbar-stick-white" data-navbar="sticky">
        <div class="container">

            <div class="navbar-left">
                <button class="navbar-toggler" type="button">&#9776;</button>
                <a class="navbar-brand text-muted" href="{{ route('welcome') }}">RockBuzz</a>
            </div>
